...
#define LOG_ERROR(class_name, func_name) FUNC_LOG(ERROR, class_name, func_name)

#define LOG_DEBUG(class_name, func_name) FUNC_LOG(DEBUG, class_name, func_name)
