...
void WebSocketSession::on_resolve(const beast::error_code& ec,
                                  const tcp::resolver::results_type& results) {
  if (ec) {
...
void WebSocketSession::do_read() {  // NOLINT (misc-no-recursion)
  _ws.async_read(
      _buffer,
...
void WebSocketSession::do_write() {  // NOLINT (misc-no-recursion)
