...
async_rest_client::config::config()
  : timeout { 30 }
  , verify_ssl { true }
  , user_agent { "async_rest_client/1.0" }
{
}
  ...
  const config    &cfg)
{
  return std::shared_ptr<async_rest_client>(
    new async_rest_client(ioc, ssl_ctx, cfg));
}

//
// Start of async_rest_client public methods
...
void
async_rest_client::enqueue_task(std::shared_ptr<detail::base_task> task)
{
...
void
async_rest_client::process_request_queue()
{
...
void
async_rest_client::send_next_request()
{
...
void
async_rest_client::on_write(boost::system::error_code ec)
{
  cancel_timeout();
...
void
async_rest_client::on_read(boost::system::error_code ec)
{
  cancel_timeout();
...
bool
async_rest_client::is_connected() const
{
  return _connected;
}
...
void
async_rest_client::cancel_timeout()
{
  boost::system::error_code ec;
  _timer.cancel(ec);
}
...
void
async_rest_client::on_timeout(boost::system::error_code ec)
{
