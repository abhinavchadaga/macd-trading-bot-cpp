...
{
protected:
    void SetUp() override { _client = arc::create(_ioc); }
...
TEST_F(AsyncRestClientConnectTest, ConnectToRealEndpointSucceeds)
{
    LOG_INFO(
        ...
        "Test");
    auto connect_future{
        net::co_spawn(_ioc, std::bind_front(&arc::connect, _client, "https://httpbin.org/get"), net::use_future)};
...
TEST_F(AsyncRestClientConnectTest, ConcurrentConnectCalls)
{
    ...
    auto connect_future1{
        net::co_spawn(_ioc, std::bind_front(&arc::connect, _client, "https://httpbin.org"), net::use_future)};

    auto connect_future2{
        net::co_spawn(_ioc, std::bind_front(&arc::connect, _client, "https://google.com"), net::use_future)};
