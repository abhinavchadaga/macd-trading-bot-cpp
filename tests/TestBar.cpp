...
TEST_F(BarTest, ConsecutiveSameDurationBars)
{
    ...
    Bar1min bar2{"AAPL", 103.0, 106.0, 102.0, 104.0, 1200, base_time + minutes{1}};
...
TEST_F(BarTest, ConsecutiveDifferentDurationBars)
{
    ...
    Bar5min bar5min{"AAPL", 103.0, 108.0, 102.0, 106.0, 5000, base_time + minutes{1}};
...
{
    Bar1min bar1{"AAPL", 100.0, 105.0, 99.0, 103.0, 1000, base_time};
    Bar1min bar2{"AAPL", 103.0, 106.0, 102.0, 104.0, 1200, base_time + minutes{3}};
...
TEST_F(BarTest, OverlappingBars)
{
    ...
    Bar1min bar2{"AAPL", 103.0, 106.0, 102.0, 104.0, 1200, base_time + minutes{2}};
...
{
    Bar1min bar1{"AAPL", 100.0, 105.0, 99.0, 103.0, 1000, base_time};
    Bar1min bar2{"MSFT", 103.0, 106.0, 102.0, 104.0, 1200, base_time + minutes{1}};
...
{
    Bar1min         bar1min{"AAPL", 100.0, 105.0, 99.0, 103.0, 1000, base_time};
    Bar<2, minutes> bar2min{"AAPL", 103.0, 108.0, 102.0, 106.0, 2500, base_time + minutes{1}};
...
{
    Bar5min bar5min{"AAPL", 100.0, 105.0, 99.0, 103.0, 5000, sys_time<minutes>{minutes{955}}};
    Bar1h   bar1h{"AAPL", 103.0, 108.0, 102.0, 106.0, 60000, sys_time<hours>{hours{16}}};
...
{
    Bar1min bar1min{"AAPL", 100.0, 105.0, 99.0, 103.0, 1000, base_time};
    Bar1h   bar1h{"AAPL", 103.0, 108.0, 102.0, 106.0, 60000, time_point_cast<hours>(base_time + minutes{30})};
...
TEST_F(BarTest, EdgeCaseVerySmallGap)
{
    ...
    Bar<1, nanoseconds> bar1{"AAPL", 100.0, 105.0, 99.0, 103.0, 1000, precise_time};
    Bar<1, nanoseconds> bar2{"AAPL", 103.0, 106.0, 102.0, 104.0, 1200, precise_time + nanoseconds{2}};
...
TEST_F(BarTest, EdgeCasePreciseConsecutive)
{
    auto                precise_time = sys_time<nanoseconds>{nanoseconds{1000000000000}};
    Bar<1, nanoseconds> bar1{"AAPL", 100.0, 105.0, 99.0, 103.0, 1000, precise_time};
    Bar<1, nanoseconds> bar2{"AAPL", 103.0, 106.0, 102.0, 104.0, 1200, precise_time + nanoseconds{1}};
